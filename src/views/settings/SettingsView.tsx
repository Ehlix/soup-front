      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <Link
            to="/settings/general"
            default={true}
            className="group relative flex h-full w-fit justify-center truncate p-1 text-base transition-colors [&.active]:text-primary"
          >
            General
            <span className="absolute bottom-0 hidden h-0.5 w-full animate-shrink bg-primary group-[&.active]:block" />
          </Link>
          <Link
            to="/settings/profile"
            className="group relative flex h-full w-fit justify-center truncate p-1 text-base transition-colors [&.active]:text-primary"
